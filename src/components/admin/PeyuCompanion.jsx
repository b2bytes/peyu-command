...
import {
  ...
  TrendingUp, Package, Users, MessageSquare, Truck, FileText, Activity, Zap } from
'lucide-react';
  ...
  if (!open) {
    return (
      <button
        ...
        className={`fixed hidden ${bottomOffset} right-6 z-[100] group flex items-center gap-2 px-3 py-3 rounded-full bg-gradient-to-br from-violet-600 via-indigo-600 to-cyan-600 hover:from-violet-500 hover:via-indigo-500 hover:to-cyan-500 text-white shadow-2xl shadow-indigo-500/40 border border-white/20 transition-all hover:scale-110`}
