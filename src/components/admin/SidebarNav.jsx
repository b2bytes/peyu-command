...
import {
  ...
  Rocket, Search, Bot, Workflow,
} from 'lucide-react';

// ─── Sidebar compacto · solo lo esencial visible ────────────────────────────
// Reorganizado para que el cliente vea menos opciones de un golpe. Solo el
// grupo "Hoy" abre por defecto. Items menos usados quedaron en "Más".
export const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { path: '/admin/agente',        label: '🐢 Agente',         icon: Bot },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/admin/whatsapp',    label: 'Inbox WhatsApp',     icon: MessageSquare },
      { path: '/admin/mensajes',    label: 'Centro de Mensajes', icon: MessageSquare },
      { path: '/admin/secuencias',  label: 'Secuencias Auto',    icon: Workflow },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/admin/operaciones',   label: 'Producción',         icon: Factory },
      { path: '/admin/inventario',    label: 'Inventario',         icon: Boxes },
      { path: '/admin/bluex',         label: 'Logística Bluex',    icon: Truck },
  ...
  },
  {
    ...
    defaultOpen: false,
    items: [
      { path: '/admin/okrs',          label: 'OKRs',               icon: Flag },
      { path: '/admin/equipo',        label: 'Equipo',             icon: Users },
      { path: '/admin/calendario',    label: 'Agenda',             icon: CalendarDays },
      { path: '/admin/cotizaciones',  label: 'Cotizaciones',       icon: Receipt },
      { path: '/admin/cpq',           label: 'CPQ',                icon: Calculator },
      { path: '/admin/cliente-360',   label: 'Cliente 360°',       icon: UserCheck },
      { path: '/admin/tiendas',       label: 'Tiendas',            icon: Store },
      { path: '/admin/embudo',        label: 'Embudo',             icon: TrendingUp },
      { path: '/admin/trazabilidad-360', label: 'Trazabilidad 360°', icon: Radar },
      { path: '/admin/trazabilidad',  label: 'Trazabilidad Prod.', icon: Boxes },
      { path: '/admin/tarifas-envio', label: 'Tarifas Bluex',      icon: Truck },
      { path: '/admin/compras',       label: 'Compras',            icon: ShoppingCart },
      { path: '/admin/esg',           label: 'Sostenibilidad',     icon: Leaf },
      { path: '/admin/marketing',     label: 'Marketing Clásico',  icon: Megaphone },
      { path: '/admin/backlinks',     label: 'Backlinks',          icon: Globe },
      ...
      { path: '/admin/importar-clientes', label: 'Importar',       icon: Users },
