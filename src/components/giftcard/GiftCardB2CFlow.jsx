...
import {
  Gift, Check, Loader2, Mail, ArrowLeft, ArrowRight, Sparkles, Calendar
} from 'lucide-react';
...
export default function GiftCardB2CFlow() {
        ...
        <div className="space-y-5 order-2 lg:order-1">
          ...
          {step === 2 && (
            <div className="bg-white/8 backdrop-blur-md border border-white/15 rounded-3xl p-6 sm:p-8 shadow-2xl">
              ...
              <RecipientForm form={form} setForm={setForm} fechaEnvio={fechaEnvio} setFechaEnvio={setFechaEnvio} />
