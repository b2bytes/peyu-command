...
export const ROADMAP = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Checkout con pasarela de pago (MercadoPago + WebPay + Transferencia)', status: 'done', page: '/CheckoutNuevo' },
      { name: 'Tienda Nueva V2 (home, catálogo, ficha cockpit, carrito)', status: 'done',       page: '/CatalogoNuevo' },
      { name: 'Personalizador láser en vivo con mockup real al pedido',   status: 'done',       page: '/ProductoNuevo' },
      { name: 'Compra directa B2B con logo + precios por tramo',          status: 'done',       page: '/EmpresasNuevo' },
      { name: 'Landing Fiestas Patrias (canasta + empresas)',             status: 'done',       page: '/fiestas-patrias' },
    ],
  },
  {
    id: 'gift-cards',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'WooCommerce Import (staging)',                             status: 'done',       page: '/admin/woocommerce' },
      { name: 'Promoción de items desde staging',                         status: 'done',       fn: 'wooPromoteStaging' },
      { name: 'BlueExpress productivo (OT + etiqueta + tracking CRON)',   status: 'done',       page: '/admin/bluex' },
      { name: 'Meta Ads API (campañas, presupuesto, fatiga)',             status: 'done',       fn: 'metaAdsManage' },
      { name: 'Instagram + LinkedIn publicación automática',              status: 'done',       page: '/admin/social-studio' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Agente B2B Triage WhatsApp (cotiza + link de pago)',       status: 'done',       page: '/admin/whatsapp' },
      { name: 'Agent OS interno para fundadores (Warm Dusk)',             status: 'done',       page: '/admin/agente' },
      { name: 'Estratega Meta Ads con memoria persistente',               status: 'done',       page: '/admin/social-studio' },
    ],
  },
  {
    id: 'plataforma',
    ...
    items: [
      ...
      { name: 'Facturación & Créditos para fundadores',                   status: 'done',       page: '/admin/facturacion' },
      { name: 'Auditoría de automatizaciones (57 activas / 74)',          status: 'done' },
