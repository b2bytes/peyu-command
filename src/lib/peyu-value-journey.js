...
export const TIMELINE = [
  ...
  {
    mes: 'Mes 3 en adelante',
    titulo: 'Aquí empieza la conversación que tenemos hoy',
    descripcion: 'Este 3er mes es el último cubierto por los $750K iniciales, y también el punto donde necesitamos emparejar la cuota mensual al valor real. La plataforma vale mucho más de $250K/mes — esta propuesta existe para encontrar un valor justo y desde ya encender el motor.',
    pagado: null,
    es_futuro: true,
    entregables: [
      'Encendido de campañas Google Ads (PMax + Search Defense)',
      'Google Ads gestionado por agente IA Commander',
