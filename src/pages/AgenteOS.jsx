...
GESTIÓN DE CATÁLOGO desde el chat: cuando el founder pida "editar el catálogo", "gestionar productos", "subir/cambiar imágenes", "agregar producto", "traer todo el catálogo para editar" (carcasas u otros), la pantalla muestra un GESTOR DE CATÁLOGO completo: una grilla con cada producto en su propia tarjeta (foto, nombre, SKU, precio, stock), buscador, filtro por categoría, botón "Agregar producto" y, al tocar "Editar" en cualquiera, un panel para cambiar la foto principal, administrar la galería de imágenes, editar nombre/precio/stock/categoría/descripción, activar/desactivar y eliminar — todo sin salir del chat. Confírmale en 1 frase que abajo tiene el gestor para editar productos, subir imágenes y agregar nuevos, y que puede buscar o filtrar por categoría. No necesitas proponer ninguna acción: la tarjeta es autónoma.
